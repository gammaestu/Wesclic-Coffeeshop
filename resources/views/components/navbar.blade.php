<nav class="bg-[#F7F7F2] border-b border-[#A3B18A]/20 sticky top-0 z-50 backdrop-blur-sm bg-opacity-95">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="{{ route('orders.status') }}" class="text-[#3A3A3A] hover:text-[#B08968] transition-colors duration-200 font-medium {{ request()->routeIs('orders.*') ? 'text-[#B08968] border-b-2 border-[#B08968]' : '' }}">
                    Lacak Pesanan
                </a>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-[#F7F7F2] border-t border-[#A3B18A]/20">
        <div class="px-4 pt-2 pb-4 space-y-2">
            ...
            <a href="{{ route('orders.status') }}" class="block px-3 py-2 text-[#3A3A3A] hover:bg-[#A3B18A]/10 rounded-lg transition-colors {{ request()->routeIs('orders.*') ? 'bg-[#A3B18A]/20 text-[#B08968]' : '' }}">
                Lacak Pesanan
            </a>
