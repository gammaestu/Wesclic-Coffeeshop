...
@section('description', 'Review your order and proceed to checkout')

@section('content')
    {{-- Page Header --}}
    <section class="bg-gradient-to-r from-[#A3B18A] to-[#B08968] text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-5xl font-bold mb-4 font-serif">Shopping Cart</h1>
            <p class="text-xl text-white/90">Review your order</p>
        </div>
    </section>
            ...
            <div id="cart-container" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div id="cart-items" class="bg-white rounded-xl shadow-lg p-6">
                        <h2 class="text-2xl font-bold mb-6 text-[#3A3A3A] font-serif">Your Items</h2>
                        ...
                        <div id="empty-cart" class="text-center py-12 hidden">
                            ...
                            <p class="text-xl text-[#3A3A3A]/70 mb-4">Your cart is empty</p>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-xl shadow-lg p-6 sticky top-24">
                        <h2 class="text-2xl font-bold mb-6 text-[#3A3A3A] font-serif">Order Summary</h2>
            ...
            <div class="flex items-center justify-between p-4 border border-[#A3B18A]/20 rounded-lg">
                <div class="flex items-center space-x-4 flex-1">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-[#3A3A3A]/70">$${item.price.toFixed(2)} each</p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    ...
                    <div class="text-right">
                        <p class="font-bold text-[#B08968]">$${((item.quantity || 1) * item.price).toFixed(2)}</p>
                    </div>
